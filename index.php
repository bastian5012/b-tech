...
<!--        <script>
    ...
    <body>
        ...
        <div class="slider">
            <img src="images/slider.jpg" class="img-responsive imgSlider" />
<!--            <div class="texteSlider">SITE<br/> INTERNET<br/>DEPANNAGE<br/>DEVELOPPEMENT</div>-->
        </div>
        <main>
            <div class="container">
                <div class="row globalContent">
                    ...
                    <div class="col-md-4 page-right">
                        ...
                        <form class="row">
                            ...
                            <div class="col-md-3">
                                <button type="submit" class="btn btn-default btnDepannage">Suivant ></button>
                            </div>
                        </form>
                ...
                <div class="row offre">
                    <div class="col-md-4 box">
                        <h3>PC Portable</h3>
                        <div class="prixOffre">CHF 1799</div>

                        <img src="images/pc.jpg" class="imgOffre"/>
                        <table class="table table-condensed">
                            <thead>
                                <tr>
                                    <th>HP Pavillon D8980</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td>Processeur Intel i5 2.55GHz</td>
                                </tr>
                                <tr>
                                    <td>4GB de DDR3</td>
                                </tr>
                                <tr>
                                    <td>Disque dur SATA 250GB</td>
                                </tr>
                            </tbody>
                        </table>
                        <button type="button" class="btn btn-primary btnCommander">COMMANDER</button>
                    </div>
